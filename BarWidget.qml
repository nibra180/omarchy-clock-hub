...
BarWidget {
  ...
  readonly property string configuredFormat: vertical
    ...
    : setting("format", "'KW'ww · dddd, dd.MM.yyyy · HH:mm")
  ...
  readonly property real openPanelIndicatorWidth: root.vertical ? button.labelWidth : clockRow.implicitWidth
  ...
  WidgetButton {
    ...
    fixedWidth: root.vertical ? -1 : clockRow.implicitWidth + scaledHorizontalMargin * 2
    fixedHeight: root.vertical ? root.verticalLines.length * Style.bar.iconSlot : -1
    horizontalMargin: 8.75
    verticalPadding: 8.75
    tooltipText: root.mediaPlaying
      ? "Playing: " + root.mediaTitle + (root.mediaArtist ? " — " + root.mediaArtist : "")
      : ""
